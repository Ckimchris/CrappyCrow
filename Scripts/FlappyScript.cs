...
public class FlappyScript : MonoBehaviour
{
	...
	public GameObject Poop_Emitter;
	public GameObject Poop1;

	public float Poop_Force = 10;
    ...
    void Update()
    {
        ...
        else if (GameStateManager.GameState == GameState.Playing)
        {
            ...
            {
                BoostOnYAxis();
				GameObject Temporary_Poop_Handler;
				Temporary_Poop_Handler = Instantiate(Poop1,Poop_Emitter.transform.position,Poop_Emitter.transform.rotation) as GameObject;

				Rigidbody2D Temporary_RigidBody;
				Temporary_RigidBody = Temporary_Poop_Handler.GetComponent<Rigidbody2D>();

				Temporary_RigidBody.AddForce(transform.right * Poop_Force);
				Destroy(Temporary_Poop_Handler, 1.0f);
